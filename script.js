// script.js - basic fetch-based client to call api.php
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Helper: fetch and show expenses for month
  ...
  expenseForm.addEventListener('submit', async (e) => {
    ...
    // Basic validation
    if (!payload.month || !payload.type || !payload.amount) {
    ...
    try {
      ...
      // if viewing the same month, reload
      ...
      console.error(err);
      alert('Network error while saving.' + err);
    }
  });
  ...
  // initial load: nothing selected
  currentMonth.textContent = '—';
  expensesList.innerHTML = '<li>Select a month to view expenses.</li>';
